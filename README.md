...
- `POST /ai/chat/sessions/{session_id}/turns` (creates turn with model-backed + guard-railed proposed parameter changes, with heuristic fallback; includes tonal/color keys such as temperature, tint, highlights/shadows, and RGB balance)
